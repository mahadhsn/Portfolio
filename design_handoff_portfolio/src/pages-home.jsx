    ...
    <main className="page page-enter">
      <section className="home-hero">
        ...
        <h1 className="home-name">
          ...
          <span
            className="char red"
            style={{ animationDelay: `${0.4 + name.length * 0.07}s` }}
          >
            .
          </span>
        </h1>
        ...
        <p className="home-tag">
          Software engineer building <em>clean systems</em> and integrating{" "}
          <em>AI-based solutions</em>. Currently doing my third year at McMaster
          — previously at TD. Outside the editor I shoot film, write logs, and
          learn piano.
        </p>
      ...
      <div className="featured" onClick={() => navigate("/projects")}>
        <div>
          <div className="featured-eyebrow">
            FEATURED · MacEngComp '25 Winner
          </div>
          <h2 className="featured-title">PrepPal</h2>
          <div className="featured-sub">
            Disaster awareness + emergency-support web app helping people make
            informed decisions before and during natural disasters.
          </div>
        </div>
        <div className="featured-cta">
          Try it out <Icon.arrowUpRight />
        </div>
      </div>
