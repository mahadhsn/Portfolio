    ...
    <main className="page page-enter">
      ...
      <div className="resume-head">
        ...
        <div className="resume-actions">
          <Button variant="primary" icon={false}><Icon.download /> <span style={{ marginLeft: 6 }}>Download PDF</span></Button>
      ...
      <div className="resume-frame stagger">
        <h1>Mahad Hassan</h1>
        <div className="resume-contact">Hamilton, ON · mahad@example.com · linkedin.com/in/mahadhssn · github.com/mahadhssn</div>

        <h3>Education</h3>
        <div className="job">
          <div className="job-head">
            <div className="job-title">McMaster University — B.Eng. Software Engineering</div>
        ...
        <div className="job">
          ...
          <p>Shipped internal tooling to help engineers triage incidents faster. Built on React / Node; integrated with existing observability pipeline.</p>
        </div>
        <div className="job">
          <div className="job-head">
          ...
          <div className="job-company">Toronto, ON</div>
          <p>Audited legacy applications for common vulnerabilities and wrote a playbook for the in-house team.</p>
        </div>
        ...
        <div className="job">
          ...
          <p>Disaster-awareness web app with an AI support flow for triaging emergency steps.</p>
        </div>
        <div className="job">
          <div className="job-head">
          ...
          <p>8-layer CNN in Python reaching 99.3% accuracy on handwritten digit classification.</p>
        </div>

        <h3>Skills</h3>
        <p>Python · Java · C · TypeScript · React · Node · PyTorch · PostgreSQL · Linux</p>
      </div>
      ...
      <div className="contact-grid">
        <div>
          ...
          <p className="subtle" style={{ fontSize: '17px', maxWidth: '380px' }}>
            Whether it's a project, an internship, or just to swap book recs — my inbox is open.
          </p>
        ...
        <form className="contact-form" onSubmit={submit}>
          {sent ? (
            <div style={{ padding: '40px 0', textAlign: 'center' }}>
              <div style={{ fontFamily: 'var(--font-display)', fontSize: '40px', color: 'var(--accent)', letterSpacing: 'var(--display-tracking)' }}>Thanks!</div>
              <p className="subtle" style={{ marginTop: '12px' }}>I'll be in touch shortly.</p>
            </div>
          ) : (
            <>
