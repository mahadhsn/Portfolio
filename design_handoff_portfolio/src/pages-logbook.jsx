...
function PageLogbook() {
  ...
  return (
    <main className="page page-enter">
      ...
      <div className="logbook-head">
        <div>
          ...
          <p className="subtle" style={{ fontSize: "18px", maxWidth: "540px" }}>
            Where I keep the raw version of what I'm learning, building, and
            shooting.
          </p>
            ...
            {tags.map((t) => (
              <button
                ...
                style={{
                  ...
                  color: tag === t ? "var(--accent-ink)" : "",
                  background:
                    tag === t ? "var(--accent-soft)" : "var(--bg-sunk)",
                }}
                onClick={() => setTag(t)}
              >
                {t}
      ...
      <div className="photo-grid">
        {PHOTOS.map((p, i) => (
          <div
            ...
            key={p.id}
            onClick={() => navigate(`/logbook/photo/${p.id}`)}
          >
      ...
      >
        All opinions here are my own. All images are mine unless otherwise
        stated.
      </p>
