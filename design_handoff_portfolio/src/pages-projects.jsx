...
function PageProjects() {
  ...
  return (
    <main className="page page-enter">
      ...
      <h1 className="display page-title">Things I've<br />built lately.</h1>
      <p className="proj-intro">
        A sampler of my work. Full catalog lives on <a style={{ color: 'var(--accent)', textDecoration: 'underline', textUnderlineOffset: '4px' }} href="#">GitHub</a>.
      </p>
        ...
        <div className="proj-featured">
          <div className="proj-featured-body">
            <div className="eyebrow" style={{ margin: 0 }}>
              <span style={{ color: 'var(--accent)' }}>★</span> FEATURED · {featured.award}
            </div>
            <h2>{featured.title}</h2>
            <p style={{ color: 'var(--ink-soft)', fontSize: '16px', lineHeight: 1.5, margin: '0 0 20px' }}>{featured.desc}</p>
      ...
      <div className="proj-list">
        {rest.map((p, i) => (
          <div className="proj-row" key={p.id}>
            ...
            <div className="proj-tag">{p.tag} · {p.year}</div>
            <div className="proj-arrow"><Icon.arrowUpRight /></div>
          </div>
        ))}
      </div>
