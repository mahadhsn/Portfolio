...
const THEMES = [
  {
    ...
    swatch: "#2d4cc8",
    swatchDark: "#e84a5f",
    desc: "Blue light · red dark (default)",
  },
  {
    id: "precise",
    label: "Precise",
    ...
    <div className="tweaks">
      ...
      <div className="tweak-group">
        ...
        <div className="swatch-row" style={{ gridTemplateColumns: "1fr 1fr" }}>
          <button
            className={`swatch ${mode === "light" ? "active" : ""}`}
            onClick={() => onModeChange("light")}
          >
            <div
              className="swatch-chip"
              style={{ background: "#f5f1ea", border: "1px solid #ccc" }}
            />
            <div>Light</div>
          </button>
          <button
            className={`swatch ${mode === "dark" ? "active" : ""}`}
      ...
      >
        Three directions to explore — pick one and the whole site reflows with
        it. Light-first is default.
      </p>
    </div>
  );
}
