...
I experimented with network depth, pooling strategies, and dropout rates to understand their effects on convergence and generalization. The jump from 97% to 99%+ accuracy came mostly from adding more convolutional layers and tuning the learning rate — simpler than I expected.
