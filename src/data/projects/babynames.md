...
Bash rewards you for knowing your Unix tools well. Once you understand the composability model — small programs that do one thing and pipe output to the next, and you can accomplish a lot with very little code.
