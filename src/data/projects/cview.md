C-View is a lightweight command-line image processor written entirely in C. It can load, manipulate, and save images using only the standard library — no external dependencies.
