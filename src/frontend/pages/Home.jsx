    ...
    <h1 className='text-3xl md:text-5xl text-center mb-7 flex items-center justify-center'>
      ...
      <span className='text-lg md:text-xl'>
        ...
        <p className='mb-6'>
          ...
          ego. <span className='text-m md:text-lg'>(check out more below!)</span>
        </p>

        <p className=''>
          I’d love to connect with you! Feel free to reach out through my contact page or drop me an email at 
          <a href='mailto:mahadhassan.hello@gmail.com' target="_blank" rel="noopener noreferrer" className='underline'>mahadhassan.hello@gmail.com</a>
