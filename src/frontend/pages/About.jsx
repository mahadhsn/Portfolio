  ...
  return (
    <div className='text-textlight dark:text-textdark animate-fade-in mt-10 md:mt-[20%] transition-all duration-300 ease-in-out'>
      ...
      <div className='text-lg md:text-xl'>
        <p className='mt-8'>
          <span className='font-bold'>Hello!</span> I am someone who is always looking to try out new things. I sound like every other person on the internet
        ...
        <p className='mt-8 mb-8'>
          I put huge emphasis on bettering myself whether that be mentally, physically, and even emotionally.
        ...
        <span className=''>
          ...
          <ul className='list-disc list-inside mb-8'>
            <li> 3<span className='text-sm'>rd</span> year Software Engineering student 🖥️</li>
            <li> Software Engineering Intern at <a href='https://www.td.com/ca/en/personal-banking' target="_blank" rel="noopener noreferrer" className='underline'>TD</a> 🟩 </li>
            <li> VP of Operations 
