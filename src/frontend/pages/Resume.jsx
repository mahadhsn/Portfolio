    ...
    <div className="resume-doc">
      ...
      <section className="resume-section">
        ...
        <div className="resume-entry">
          ...
          <ul className="resume-bullets">
            ...
            <li>
              <strong>Courses:</strong> Data Structures & Algorithms · OOP
              (Java) · Development (C, Git, Bash) · Math in Python · Databases
              (SQL)
            </li>
            <li>
      ...
      <section className="resume-section">
        ...
        <ul className="resume-skills-list">
          <li>
            <strong>Languages:</strong> C/C++, Python, MATLAB, Bash, Verilog,
            Java, SQL, TypeScript
          </li>
          <li>
            <strong>Embedded & Systems:</strong> Linux, Jetson Nano, Firmware
            (C/C++), Telemetry Systems, Serial I/O, MATLAB/Simulink
          </li>
          <li>
            <strong>Machine Learning & CV:</strong> TensorFlow, OpenCV, NumPy,
            Pandas, Matplotlib, Model Optimization, Training & Inference
          </li>
          <li>
            <strong>Tools:</strong> Git/GitHub, Jupyter, VS Code, PyCharm,
            Anaconda, Vim, Onshape, KiCad, Maven
          </li>
          <li>
            <strong>Web & DevOps:</strong> React.js, Node.js, Firebase,
            Terraform, GitHub Actions, CI/CD, Cloud (AWS/Azure)
          </li>
        </ul>
      </section>
      ...
      <section className="resume-section">
        ...
        <div className="resume-entry">
          ...
          <ul className="resume-bullets">
            <li>
              Developed <strong>FRAM</strong>, a microservice in Java/Spring on
              Azure using Kafka for data transfer and async design
            </li>
            <li>
              Migrated API client processing to non-blocking, concurrent
              execution, delivering <strong>$1M/year</strong> in infrastructure
              savings
            </li>
            <li>
              Analyzed service performance and failure modes across distributed
              components to improve reliability under production load
            </li>
            <li>
              Optimized CI/CD pipelines via GitHub Actions, reducing deployment
              time by 20% across 7 distributed services
            </li>
            <li>
              Updated <strong>Terraform</strong> configurations to support
              infrastructure <strong>failover testing</strong> in secondary
              environments
            </li>
          </ul>
        </div>
        ...
        <div className="resume-entry">
          ...
          <ul className="resume-bullets">
            ...
            <li>
              ...
              (CUDA-accelerated) for low-latency, real-time processing
            </li>
            <li>
              Iterating on preprocessing, input resolution, and model parameters
              to balance accuracy with real-time inference constraints
            </li>
            <li>
            ...
            <li>
              Processing depth and telemetry streams to improve inference
              stability, robustness, and real-world accuracy
            </li>
          </ul>
        </div>
        ...
        <div className="resume-entry">
          ...
          <ul className="resume-bullets">
            <li>
              Developing an <strong>app</strong> with{" "}
              <strong>React Native</strong> and <strong>Firebase</strong> to
              centralize <strong>mental</strong>, <strong>physical</strong>, &{" "}
              <strong>financial</strong> support for patients
            </li>
            <li>
              Implementing end-to-end <strong>encryption</strong>, including a{" "}
              <strong>secure medical resume</strong> section and{" "}
              <strong>protected data storage</strong>
            </li>
            <li>
              Designing an <strong>accessible</strong>, user-focused interface
              to ensure <strong>privacy</strong>, <strong>data security</strong>
              , and <strong>seamless patient interaction</strong>
            </li>
          </ul>
        </div>
      </section>
          ...
          <div className="resume-entry-head">
            <div className="resume-entry-org">
              ...
              <span className="resume-proj-stack">
                TypeScript (React, Tailwind CSS), Python (TensorFlow,
                Matplotlib)
              </span>
            </div>
          </div>
        ...
        <div className="resume-entry">
          <div className="resume-entry-head">
            <div className="resume-entry-org">
              ...
              <span className="resume-proj-stack">
                TypeScript (React, Next.js), Tailwind CSS, GCP Vision, OpenAI
              </span>
            </div>
        ...
        <div className="resume-entry">
          <div className="resume-entry-head">
            <div className="resume-entry-org">
              ...
              <span className="resume-proj-stack">
                Python (OpenCV, Flask, Cryptography), SQL, Git
              </span>
            </div>
            <span className="resume-entry-date resume-award">
              2nd · MacEngComp 24'
