  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setStatus('You have reached the email sending limit for today. Please reach out tomorrow and I will be sure to respond!');
      }
      else {
  ...
  return (
    <div className='text-white animate-fade-in flex flex-col items-center w-full -mt-2 md:mt-[10%]'>
      ...
      <form className='w-full max-w-md bg-neutral-800 p-6 rounded-lg shadow-lg' onSubmit={handleSubmit}>
        ...
        <div className="mb-4">
          <label htmlFor="subject" className="block text-lg font-semibold">Subject</label>
          <textarea
            id="subject"
            value={subject}
